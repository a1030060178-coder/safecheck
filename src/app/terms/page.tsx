  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-16">
      ...
      <p className="text-zinc-600 mb-4">
        SafeCheck provides a daily check-in reminder service. Users receive email
        ...
        period, SafeCheck sends an alert to the user's designated emergency contacts.
      </p>

      <h2 className="text-xl font-semibold mt-8 mb-3">2. No Emergency Service</h2>
      <p className="text-zinc-600 mb-4">
        SafeCheck is NOT an emergency response service. We do not contact police,
      ...
      <p className="text-zinc-600 mb-4">
        SafeCheck Pro is a monthly subscription at $5/month. You may cancel anytime.
      ...
      <p className="text-zinc-600 mb-4">
        SafeCheck is provided as-is. We are not liable for any harm, injury, or loss
        resulting from the use or failure of this service. You use SafeCheck at your
        own risk.
      </p>
