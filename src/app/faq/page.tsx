...
export const metadata: Metadata = {
  title: "FAQ — SafeCheck Daily Safety Check-In",
  description: "Frequently asked questions about SafeCheck. How it works, pricing, privacy, and more.",
};

const faqs = [
  { q: "How does SafeCheck work?", a: "Set a daily check-in time. We email you at that time with a one-click link. Click the link to confirm you're safe. If you miss your window + grace period, we automatically alert your emergency contacts." },
  { q: "Is SafeCheck really free?", a: "Yes. The free tier includes 1 daily check-in and 1 emergency contact. Pro ($5/month) adds unlimited check-ins, 5 contacts, SMS alerts, and activity history." },
  ...
  { q: "Will you call 911 or emergency services?", a: "No. SafeCheck is not an emergency response service. We only notify the emergency contacts you designate. You are responsible for ensuring your contacts are willing and able to check on you." },
  ...
  { q: "Does it work on mobile?", a: "Yes. SafeCheck is a web app — it works on any device with a browser and internet connection. No app download needed." },
  ...
  { q: "Who built SafeCheck?", a: "A solo developer who lives alone and wanted peace of mind. Built over a weekend for $0 using Next.js, Supabase, and Resend. Open source on GitHub." },
];
...
export default function FAQPage() {
  return (
    <div className="max-w-2xl mx-auto px-6 py-16">
      ...
      <p className="text-zinc-500 mb-10">Everything you need to know about SafeCheck.</p>
